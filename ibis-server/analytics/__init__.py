"""Initialization for the Analytics module."""
...
def __dir__() -> list[str]:
    """Adds tab completion for analytics to the top-level module."""
    out = set(__all__)
    return sorted(out)
...
def create_session_context(
    ...
    **kwargs: dict,
    ...
    """Create an Analytics session context.
