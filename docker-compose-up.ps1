# PowerShell script to run docker-compose with automatic JAR build if needed
# This script checks if the JAR file exists, builds it if missing, then runs docker-compose
