...
The crate includes several examples of how to use Analytics Engine APIs and help you on your way.
...
```bash
git clone https://github.com/Canner/analytics-engine.git
cd analytics-engine/analytics-core
