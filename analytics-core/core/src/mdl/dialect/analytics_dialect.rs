...
/// AnalyticsDialect is a dialect for Analytics engine. Handle the identifier quote style based on the
/// original Datafusion Dialect implementation but with more strict rules.
/// If the identifier isn't lowercase, it will be quoted.
pub struct AnalyticsDialect {
    inner_dialect: Box<dyn InnerDialect>,
}

impl Dialect for AnalyticsDialect {
...
impl Default for AnalyticsDialect {
    fn default() -> Self {
        AnalyticsDialect::new(&DataSource::default())
    }
}

impl AnalyticsDialect {
