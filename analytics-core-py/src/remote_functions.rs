...
use std::fmt::Display;
use std::str::FromStr;
use analytics_core::mdl::function::FunctionType;
...
impl From<analytics_core::mdl::function::RemoteFunction> for PyRemoteFunction {
    fn from(remote_function: analytics_core::mdl::function::RemoteFunction) -> Self {
...
impl From<PyRemoteFunction> for analytics_core::mdl::function::RemoteFunction {
    fn from(
        remote_function: PyRemoteFunction,
    ) -> analytics_core::mdl::function::RemoteFunction {
