...
public class TestingAnalyticsServer
        implements Closeable
{
    ...
    private TestingAnalyticsServer(Map<String, String> requiredConfigs)
            throws IOException
    {
    ...
    public static class Builder
    {
        ...
        public TestingAnalyticsServer build()
        {
            try {
                ...
                properties.store(Files.newBufferedWriter(config), "TestingAnalyticsServer");
                return new TestingAnalyticsServer(configs);
            }
