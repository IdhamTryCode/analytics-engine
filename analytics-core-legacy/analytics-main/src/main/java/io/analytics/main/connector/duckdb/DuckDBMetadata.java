...
package io.analytics.main.connector.duckdb;
...
import io.analytics.base.client.duckdb.DuckDBSettingSQL;
import io.analytics.base.client.duckdb.DuckdbClient;
        ...
        implements Metadata
{
            ...
            ConfigManager configManager)
    {
        ...
        if (configManager.getConfig(AnalyticsConfig.class).getDataSourceType().equals(AnalyticsConfig.DataSourceType.DUCKDB)) {
    ...
    public ConnectorRecordIterator directQuery(String sql, List<Parameter> parameters)
    {
        try {
            ...
            throw new AnalyticsException(GENERIC_INTERNAL_ERROR, e);
        }
    }
