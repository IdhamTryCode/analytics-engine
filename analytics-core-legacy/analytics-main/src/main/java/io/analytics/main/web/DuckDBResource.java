...
import io.analytics.base.client.duckdb.FileUtil;
...
import static io.analytics.base.metadata.StandardErrorCode.GENERIC_USER_ERROR;
            ...
            throws Exception
    {
        supplyAsync(() -> {
            try (ConnectorRecordIterator iterator = metadata.directQuery(statement, ImmutableList.of())) {
                ...
                throw new AnalyticsException(GENERIC_USER_ERROR, e);
            }
