...
package io.analytics.main.sql.duckdb;

import io.trino.sql.tree.FunctionCall;
import io.trino.sql.tree.Node;
import io.trino.sql.tree.QualifiedName;
import io.analytics.base.sqlrewrite.BaseRewriter;
import io.analytics.main.metadata.Metadata;
import io.analytics.main.sql.SqlRewrite;

import java.util.Arrays;
import java.util.List;
import java.util.stream.Collectors;

import static io.analytics.main.connector.duckdb.DuckDBMetadata.PG_TO_DUCKDB_FUNCTION_NAME_MAPPINGS;
