...
import static io.analytics.base.metadata.StandardErrorCode.GENERIC_INTERNAL_ERROR;
...
public final class AnalyticsExceptionMapper
        implements ExceptionMapper<Throwable>
{
    private static final Logger LOG = Logger.get(AnalyticsExceptionMapper.class);
    ...
    public Response toResponse(Throwable throwable)
    {
        ...
        if (throwable instanceof AnalyticsException) {
            return failure((AnalyticsException) throwable);
        }
        else if ((throwable instanceof ExecutionException || throwable instanceof CompletionException)
                && throwable.getCause() instanceof AnalyticsException) {
            return failure((AnalyticsException) throwable.getCause());
        }
        else {
            return Response
    ...
    private static Response failure(AnalyticsException exception)
    {
    ...
    private static ErrorMessageDto createErrorMessageDto(AnalyticsException e)
    {
