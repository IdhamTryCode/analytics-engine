...
public class BigQueryConfig
{
    ...
    @ConfigDescription("Analytics needs to create two schemas in BigQuery: analytics_temp, pg_catalog. This is a config to add a prefix to the names of these two schemas if it's set.")
