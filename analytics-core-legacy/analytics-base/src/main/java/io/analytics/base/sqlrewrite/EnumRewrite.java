        ...
        implements AnalyticsRule
{
    ...
    {
        return (Statement) new Rewriter(analyzedMDL.getAnalyticsMDL()).process(root);
    }
            ...
            extends BaseRewriter<Void>
    {
        ...
        Rewriter(AnalyticsMDL analyticsMDL)
        {
        ...
        private Expression rewriteEnumIfNeed(DereferenceExpression node)
        {
            ...
            Optional<EnumDefinition> enumDefinitionOptional = analyticsMDL.getEnum(enumName);
