...
import static io.analytics.base.sqlrewrite.Utils.parseQuery;
        ...
        extends RelationableSqlRender
{
    ...
    public ModelSqlRender(Relationable relationable, AnalyticsMDL mdl, Set<String> requiredFields)
    {
        super(relationable, mdl);
        this.requiredFields = requireNonNull(requiredFields);
    }

    public ModelSqlRender(Relationable relationable, AnalyticsMDL mdl)
    {
        super(relationable, mdl);
