...
import static io.analytics.base.sqlrewrite.Utils.parseView;
        ...
        implements QueryDescriptor
{
    ...
    public static ViewInfo get(View view, AnalyzedMDL analyzedMDL, SessionContext sessionContext)
    {
        ...
        StatementAnalyzer.analyze(analysis, query, sessionContext, analyzedMDL.getAnalyticsMDL());
        ...
        return new ViewInfo(view.getName(), analysis.getAnalyticsObjectNames(), query);
    }
