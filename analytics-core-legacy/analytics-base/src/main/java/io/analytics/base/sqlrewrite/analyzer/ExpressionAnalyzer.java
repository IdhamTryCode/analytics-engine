...
public class ExpressionAnalyzer
{
    ...
    public static ExpressionAnalysis analyze(Scope scope, Expression expression, SessionContext sessionContext, AnalyticsMDL analyticsMDL, Analysis analysis)
    {
        ExpressionVisitor visitor = new ExpressionVisitor(scope, sessionContext, analyticsMDL, analysis);
            ...
            extends DefaultTraversalVisitor<Void>
    {
        ...
        {
            StatementAnalyzer.analyze(analysis, node.getQuery(), sessionContext, analyticsMDL, Optional.of(scope));
            return null;
        }
