...
import static io.analytics.base.sqlrewrite.EnumRewrite.ENUM_REWRITE;
import static io.analytics.base.sqlrewrite.MetricRollupRewrite.METRIC_ROLLUP_REWRITE;
...
{
    public static final List<AnalyticsRule> ALL_RULES = List.of(
            GenerateViewRewrite.GENERATE_VIEW_REWRITE,
            METRIC_ROLLUP_REWRITE,
            ANALYTICS_SQL_REWRITE,
            ENUM_REWRITE);
    private static final SqlParser SQL_PARSER = new SqlParser();

    private AnalyticsPlanner() {}
    ...
    public static String rewrite(String sql, SessionContext sessionContext, AnalyzedMDL analyzedMDL, List<AnalyticsRule> rules)
    {
