        ...
        implements QueryDescriptor
{
    ...
    public static RelationInfo get(Relationable relationable, AnalyticsMDL mdl, Set<String> requiredFields)
    {
    ...
    public static RelationInfo get(Relationable relationable, AnalyticsMDL mdl)
    {
        if (relationable instanceof Model) {
