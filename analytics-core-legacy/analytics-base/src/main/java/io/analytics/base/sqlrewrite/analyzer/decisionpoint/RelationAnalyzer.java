...
public class RelationAnalyzer
{
    ...
    public static RelationAnalysis analyze(Relation relation, SessionContext sessionContext, AnalyticsMDL analyticsMDL, Analysis analysis)
    {
        return new Visitor(sessionContext, analyticsMDL, analysis).process(relation, null);
    }
            ...
            extends AstVisitor<RelationAnalysis, Void>
    {
        ...
        public Visitor(SessionContext sessionContext, AnalyticsMDL analyticsMDL, Analysis analysis)
        {
        ...
        {
            List<QueryAnalysis> analyses = DecisionPointAnalyzer.analyze(node.getQuery(), sessionContext, analyticsMDL)
