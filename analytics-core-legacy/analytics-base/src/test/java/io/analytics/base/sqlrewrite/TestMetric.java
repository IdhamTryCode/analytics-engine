...
import io.analytics.base.dto.TimeGrain;
        ...
        extends AbstractTestFramework
{
        ...
        manifest = withDefaultCatalogSchema()
                .setModels(List.of(
                        Model.onTableReference("Orders",
                                ...
                                List.of(
                                        ...
                                        Column.calculatedColumn("customer_name", AnalyticsTypes.VARCHAR, "customer.name"),
                                        Column.calculatedColumn("cumstomer_address", AnalyticsTypes.VARCHAR, "customer.address"),
                ...
                .setMetrics(List.of(
                        Metric.metric("TotalpriceByCustomer", "Customer",
                                List.of(
                                        Column.column("name", AnalyticsTypes.VARCHAR, null, true),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "orders.orderdate")),
                                List.of(
                                        Column.column("totalprice", AnalyticsTypes.INTEGER, null, true, "sum(orders.totalprice)")),
                                List.of(
                        ...
                        Metric.metric("TotalpriceByCustomerYear", "Customer",
                                List.of(
                                        Column.column("name", AnalyticsTypes.VARCHAR, null, true),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "date_trunc('YEAR', orders.orderdate)")),
                                List.of(
                                        Column.column("totalprice", AnalyticsTypes.INTEGER, null, true, "sum(orders.totalprice)")),
                                List.of(
                                        TimeGrain.timeGrain("orderdata", "orderdate", List.of(TimeUnit.DAY, TimeUnit.MONTH, TimeUnit.YEAR)))),
                        Metric.metric("TotalpriceByCustomerBaseOrders", "Orders",
                                List.of(
                                        Column.column("name", AnalyticsTypes.VARCHAR, null, true, "customer.name"),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true)),
                                List.of(
                                        Column.column("totalprice", AnalyticsTypes.INTEGER, null, true, "sum(totalprice)")),
                                List.of(
                                        TimeGrain.timeGrain("orderdata", "orderdate", List.of(TimeUnit.DAY, TimeUnit.MONTH, TimeUnit.YEAR)))),
                        Metric.metric("TotalpriceByCustomerBaseOrdersYear", "Orders",
                                List.of(
                                        Column.column("name", AnalyticsTypes.VARCHAR, null, true, "customer.name"),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "date_trunc('YEAR', orderdate)")),
                                List.of(
                                        Column.column("totalprice", AnalyticsTypes.INTEGER, null, true, "sum(totalprice)")),
                                List.of()),
                        Metric.metric("NumberCustomerByDate", "Orders",
                                List.of(Column.column("orderdate", AnalyticsTypes.DATE, null, true)),
                                List.of(Column.column("count_of_customer", AnalyticsTypes.INTEGER, null, true, "count(distinct customer.name)")),
                                List.of()),
                        Metric.metric("SumExtendedPriceByCustomer", "Customer",
                                List.of(Column.column("name", AnalyticsTypes.VARCHAR, null, true),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "orders.orderdate")),
                                List.of(Column.column("sum_extendprice", AnalyticsTypes.INTEGER, null, true, "sum(orders.lineitem.extendedprice)")),
                                List.of()),
                        Metric.metric("SumExtendedPriceByCustomerBaseLineitem", "Lineitem",
                                List.of(Column.column("name", AnalyticsTypes.VARCHAR, null, true, "order_record.customer.name"),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "order_record.orderdate")),
                                List.of(Column.column("sum_extendprice", AnalyticsTypes.INTEGER, null, true, "sum(extendedprice)")),
                                List.of()),
                        Metric.metric("RevenueByCustomer", "Customer",
                                List.of(Column.column("name", AnalyticsTypes.VARCHAR, null, true),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "orders.orderdate")),
                                List.of(Column.column("revenue", AnalyticsTypes.INTEGER, null, true, "sum(orders.lineitem.extendedprice * (1 - orders.lineitem.discount))")),
                                List.of()),
                        Metric.metric("RevenueByCustomerBaseLineitem", "Lineitem",
                                List.of(Column.column("name", AnalyticsTypes.VARCHAR, null, true, "order_record.customer.name"),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "order_record.orderdate")),
                                List.of(Column.column("revenue", AnalyticsTypes.INTEGER, null, true, "sum(extendedprice * (1 - discount))")),
                                List.of()),
                        Metric.metric("SumExtendedpriceAddTotalpriceByCustomerBaseOrders", "Orders",
                                List.of(Column.column("name", AnalyticsTypes.VARCHAR, null, true, "customer.name"),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "orderdate")),
                                List.of(Column.column("extAddTotalprice", AnalyticsTypes.INTEGER, null, true, "sum(totalprice + lineitem.extendedprice)")),
                                List.of()),
                        Metric.metric("SumExtendedpriceAddTotalpriceByCustomerBaseLineitem", "Lineitem",
                                List.of(Column.column("name", AnalyticsTypes.VARCHAR, null, true, "order_record.customer.name"),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true, "order_record.orderdate")),
                                List.of(Column.column("extAddTotalprice", AnalyticsTypes.INTEGER, null, true, "sum(order_record.totalprice + extendedprice)")),
                                List.of()),
                        Metric.metric("CountOrderkey", "Orders",
                                List.of(Column.column("orderkey", AnalyticsTypes.INTEGER, null, true),
                                        Column.column("orderdate", AnalyticsTypes.DATE, null, true)),
                                List.of(Column.column("count", AnalyticsTypes.INTEGER, null, true, "count(orderkey)")),
                                List.of()),
                        Metric.metric("CountOrders", "Orders",
                                List.of(Column.column("custkey", AnalyticsTypes.INTEGER, null, true),
                                        Column.column("orderstatus", AnalyticsTypes.VARCHAR, null, true)),
                                List.of(Column.column("count", AnalyticsTypes.INTEGER, null, true, "count(*)")),
                                List.of()),
                        Metric.metric("CountOrders2", "CountOrders",
                                List.of(Column.column("orderstatus", AnalyticsTypes.VARCHAR, null, true)),
                                List.of(Column.column("sum_count", AnalyticsTypes.INTEGER, null, true, "sum(count)")),
                                List.of())))
                .build();
        analyticsMDL = AnalyticsMDL.fromManifest(manifest);
    }
    ...
    public void testModelOnMetric()
    {
        List<Model> models = ImmutableList.<Model>builder()
                ...
                .add(Model.onBaseObject(
                        ...
                        List.of(
                                Column.column("name", AnalyticsTypes.VARCHAR, null, true),
                                Column.column("revenue", AnalyticsTypes.INTEGER, null, true, "totalprice")),
                        "name"))
                .build();
    ...
    public void testMetricOnMetric()
    {
        List<Metric> metrics = ImmutableList.<Metric>builder()
                ...
                .add(Metric.metric(
                        "testMetricOnMetric",
                        "TotalpriceByCustomerBaseOrders",
                        List.of(Column.column("orderyear", AnalyticsTypes.VARCHAR, null, true, "DATE_TRUNC('YEAR', orderdate)")),
                        List.of(Column.column("revenue", AnalyticsTypes.INTEGER, null, true, "sum(totalprice)")),
                        List.of()))
                .build();
        AnalyticsMDL mdl = AnalyticsMDL.fromManifest(copyOf(manifest).setMetrics(metrics).build());
    ...
    {
        return rewrite(sql, analyticsMDL);
    }

    private String rewrite(String sql, boolean enableDynamicField)
    {
        return rewrite(sql, analyticsMDL, enableDynamicField);
    }

    private String rewrite(String sql, AnalyticsMDL analyticsMDL)
    {
        return AnalyticsPlanner.rewrite(sql, DEFAULT_SESSION_CONTEXT, new AnalyzedMDL(analyticsMDL, null), List.of(ANALYTICS_SQL_REWRITE));
    }
    ...
    private String rewrite(String sql, AnalyticsMDL analyticsMDL, boolean enableDynamicField)
    {
        SessionContext sessionContext = SessionContext.builder()
                ...
                .build();
        String result = AnalyticsPlanner.rewrite(sql, sessionContext, new AnalyzedMDL(analyticsMDL, null), List.of(ANALYTICS_SQL_REWRITE));
