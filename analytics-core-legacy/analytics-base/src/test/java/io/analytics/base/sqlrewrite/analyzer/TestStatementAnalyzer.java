...
import io.analytics.base.sqlrewrite.AbstractTestFramework;
...
import static io.analytics.base.CatalogSchemaTableName.catalogSchemaTableName;
import static io.analytics.base.AnalyticsMDL.EMPTY;
import static io.analytics.base.AnalyticsMDL.fromManifest;
...
import static io.analytics.base.sqlrewrite.analyzer.StatementAnalyzer.analyze;
        ...
        Manifest manifest = Manifest.builder()
                ...
                .setMetrics(ImmutableList.of(
                        Metric.metric("metric_1", "table_3",
                                ...
                                ImmutableList.of(Column.column("max_c2", AnalyticsTypes.INTEGER, null, false, "max(c2)")))))
                .build();
