...
import static io.analytics.base.sqlrewrite.GenerateViewRewrite.GENERATE_VIEW_REWRITE;
        ...
        extends AbstractTestFramework
{
    ...
    {
        AnalyticsMDL mdl = AnalyticsMDL.fromManifest(withDefaultCatalogSchema()
                .setModels(List.of(orders))
                .setMetrics(List.of(
                        Metric.metric("CountOrders", "Orders",
                                List.of(Column.column("custkey", AnalyticsTypes.INTEGER, null, true),
                                        Column.column("orderstatus", AnalyticsTypes.DATE, null, true)),
    ...
    private String rewrite(String sql, AnalyticsMDL analyticsMDL, boolean enableDynamicField)
    {
        SessionContext sessionContext = SessionContext.builder()
                ...
                .build();
        return AnalyticsPlanner.rewrite(sql, sessionContext, new AnalyzedMDL(analyticsMDL, null), List.of(GENERATE_VIEW_REWRITE, ANALYTICS_SQL_REWRITE));
    }
}
