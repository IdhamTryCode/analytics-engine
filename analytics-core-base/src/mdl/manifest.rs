...
mod bool_from_int {
        ...
        D: Deserializer<'de>,
    {
        ...
        match value {
            ...
            // Backward compatibility with Analytics AI manifests
            // In the legacy manifest format generated by Analytics AI, boolean values are represented as integers (0 or 1)
